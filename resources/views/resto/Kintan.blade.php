    ...
    <div class="product-imgs">
      <div class="img-display">
        <div class="img-showcase">
          <img src="img/kintan1.jpeg" alt="Gallery image 1" class="ecommerce-gallery-main-img active w-100" data-mdb-toggle="lightbox" />
          <img src="img/kintan2.jpeg" alt="Gallery image 3" class="w-100" />
          <img src="img/kintan3.jpeg" alt="Gallery image 2" class="w-100" />
      ...
      <div class="img-select">
        <div class="img-item">
          <a href="#" data-id="1">
            <img src="img/kintan1.jpeg" alt="Gallery image 1" class="w-100" />
          </a>
        </div>
        <div class="img-item">
          <a href="#" data-id="2">
    ...
    <div class="product-content">
      ...
      <div class="product-detail">
        ...
        <ul>
          ...
          <li>Menu Items:</li>
          <ul>
            <li>Super Egg Breakfast with Karaage Chicken | $9.90</li>
            <li>Medium Egg Breakfast with Bread | $7.50</li>
            <li>Boil Egg with Karaage Chicken | $6.90</li>
